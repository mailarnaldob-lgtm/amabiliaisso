...
export default function Auth() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    // Zero Shortcut Policy: All new users start INACTIVE with no tier
    ...
    if (error) {
      ...
      toast({
        title: 'Account Created - Activation Required',
        description: 'Your INACTIVE account has been created. Submit your activation payment (₱300+) to unlock the Alpha Ecosystem.'
      });
      navigate('/dashboard', { replace: true });
    }
    setIsLoading(false);
  ...
  return (
    <div className="min-h-screen flex overflow-hidden" style={{ background: '#050505' }}>
          ...
          >
            ...
            <CardContent className="pb-8">
              <Tabs defaultValue="login" className="w-full">
                ...
                {/* Registration Tab - ZERO SHORTCUT POLICY */}
                <TabsContent value="signup">
                  <form onSubmit={handleSignup} className="space-y-4 mt-4">
                    {/* Zero Shortcut Policy Warning */}
                    <Alert 
                      className="border-0" 
                      style={{
                    ...
                    >
                      ...
                      <AlertDescription className="text-xs text-muted-foreground">
                        <span className="font-bold text-orange-400">ZERO SHORTCUT POLICY:</span> All new accounts start as{' '}
                        <span className="font-bold text-orange-400">INACTIVE</span> with no tier.
                        You must submit activation payment (starting at ₱300) after registration to unlock the Alpha Ecosystem.
                      </AlertDescription>
                    </Alert>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input 
                          ...
                          required 
                          minLength={8} 
                          className={`bg-black/50 border-white/10 focus:border-[#FFD700]/50 ${signupPassword && !isPasswordValid ? 'border-destructive' : ''}`} 
                        />
                        <Button 
                          type="button" 
                          variant="ghost" 
                    ...
                    >
                      ...
                      <AlertDescription className="text-xs text-muted-foreground">
                        <span className="font-semibold text-[#FFD700]">Activation Tiers:</span>{' '}
                        <span className="text-[#FFD700] font-bold">PRO</span> (₱300) • 
                        <span className="text-[#FFD700] font-bold"> EXPERT</span> (₱600) • 
                        <span className="text-[#FFD700] font-bold"> ELITE</span> (₱900)
                        <br />
                        <span className="text-muted-foreground/70">
                          Submit payment after registration to activate your account.
                        </span>
                      </AlertDescription>
                    </Alert>
                    ...
                    <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.98 }} className="pt-2">
                      <Button 
                        ...
                        disabled={isLoading}
                      >
                        {isLoading ? 'Creating Identity...' : 'Create Inactive Account'}
                      </Button>
                    </motion.div>
                    
                    <p className="text-xs text-center text-muted-foreground">
                      After registration, navigate to <span className="text-[#FFD700] font-semibold">Upgrade Membership</span> to activate your account
                    </p>
                  </form>
                </TabsContent>
              </Tabs>
