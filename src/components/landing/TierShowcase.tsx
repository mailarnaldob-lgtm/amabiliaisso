          ...
          {tiers.map((tier, index) => (
            <motion.div
              ...
              className={cn(
                ...
                'hover:-translate-y-2',
                tier.borderColor,
                tier.popular && 'ring-2 ring-[#FFD700]/50'
              )}
            >
              {/* Popular Badge */}
              {tier.popular && (
                <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#FFD700] text-black font-bold px-4">
                  MOST POPULAR
                </Badge>
              )}
              ...
              <Link to="/auth" className="block">
                <Button 
                  className={cn(
                    ...
                    tier.name === 'Elite' 
                      ? 'bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-black hover:opacity-90'
