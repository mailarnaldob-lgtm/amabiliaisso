 ...
 * EARN Hub now opens as full-screen overlay
...
export function AlphaCoinHub() {
  ...
  const handleItemClick = (item: typeof ALPHA_HUB_ITEMS[number]) => {
    setIsOpen(false);
    // Check if this is the EARN Hub item
    if (item.label === 'EARN Hub') {
    ...
    <>
      <div className="fixed bottom-24 right-4 z-40">
          ...
          {isOpen && (
            <>
              ...
              <div className="absolute bottom-20 right-0 flex flex-col gap-3 items-end">
                {ALPHA_HUB_ITEMS.map((item, index) => {
                  const isEarnHub = item.label === 'EARN Hub';
                  ...
                  return (
                    ...
                    >
                      {isEarnHub ? (
                        // EARN Hub opens overlay instead of navigating
                        <button 
                        ...
                        >
                          ...
                          {/* Icon Button */}
                          <motion.div 
                            className={cn('w-12 h-12 rounded-full flex items-center justify-center', `bg-gradient-to-br ${item.color}`)} 
                            style={{ boxShadow: '0 4px 20px hsl(45 100% 51% / 0.25)' }} 
        ...
        <motion.button 
          ...
          style={{
            background: isOpen 
              ? 'linear-gradient(135deg, hsl(220 23% 12%) 0%, hsl(220 23% 8%) 100%)' 
              : 'linear-gradient(135deg, #d4af37 0%, #f4d03f 30%, #d4af37 60%, #aa8c2c 100%)',
            boxShadow: isOpen 
              ? '0 0 30px hsl(0 0% 0% / 0.6), inset 0 1px 0 hsl(255 255% 255% / 0.1)' 
              : '0 0 40px hsl(45 100% 51% / 0.4), 0 8px 30px hsl(0 0% 0% / 0.3), inset 0 2px 4px rgba(255,255,255,0.3), inset 0 -2px 4px rgba(0,0,0,0.2)',
        ...
        >
          ...
          {!isOpen && (
            <motion.div 
              ...
              style={{ border: '2px solid hsl(45 100% 51% / 0.6)' }} 
